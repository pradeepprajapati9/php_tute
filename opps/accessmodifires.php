...
class secdevice1 extends device1
{
...
$deviceObjectsec = new secdevice1("Moto", "Boat", "JBL", "Faster", "Dell");
...
$deviceObject = new device2("Moto", "Boat", "JBL", "Faster", "Dell");
$deviceObject->Callmethod();

class secdevice extends device2
{
    public function Callmethodsec()
    {
        // we can't access the variable private from base class
        echo "<h1>This Is secdevice class of Constructer Function Called But Not Call Because Private Method Not Allow</h1>";
        // echo " Mobile Name= " . $this->Mobile . "<br>";
        // echo " Earpone Name= " . $this->Ear . "<br>";
        // echo " Charger Name =" . $this->Char . "<br>";
        // echo " Machine Name =" . $this->Machine . "<br>";
